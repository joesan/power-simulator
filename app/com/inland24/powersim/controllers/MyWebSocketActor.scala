...
package com.inland24.powersim.controllers

import akka.actor.{Actor, ActorRef, PoisonPill, Props}
import com.inland24.powersim.models.MyMessages
...
class MyWebSocketActor(producer: ConcurrentSubject[MyMessages, MyMessages], consumer: ActorRef)
